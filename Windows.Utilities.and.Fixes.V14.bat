...
cls
title  WINDOWS TWEAKS AND FIXES V14 - Risen
mode 78, 20
...
if %_erl%==6 setlocal & call :easteregg & cls & endlocal & goto :MainMenu
if %_erl%==5 setlocal & call :MainMenu & cls & endlocal & goto :MainMenu
if %_erl%==4 setlocal & call :MainMenu & cls & endlocal & goto :MainMenu
if %_erl%==3 setlocal & call :driverupdate & cls & endlocal & goto :MainMenu
...
if %_erl%==3 exit
if %_erl%==2 setlocal & call :MainMenu & cls & endlocal & goto :driverupdate
if %_erl%==1 setlocal & call :geepeeyou & cls & endlocal & goto :driverupdate
...
if %_erl%==9 start https://www.youtube.com/watch?v=dQw4w9WgXcQ & cls & endlocal & goto :easteregg
if %_erl%==8 setlocal & call :easteregg & cls & endlocal & goto :easteregg
if %_erl%==7 setlocal & call :easteregg & cls & endlocal & goto :easteregg
if %_erl%==6 setlocal & call :easteregg & cls & endlocal & goto :easteregg
if %_erl%==5 setlocal & call :easteregg & cls & endlocal & goto :easteregg
if %_erl%==4 setlocal & call :easteregg & cls & endlocal & goto :easteregg
if %_erl%==3 setlocal & call :easteregg & cls & endlocal & goto :easteregg
if %_erl%==2 setlocal & call :utilities & cls & endlocal & goto :easteregg
if %_erl%==1 setlocal & call :fixes & cls & endlocal & goto :easteregg
...
if %_erl%==5 exit
if %_erl%==4 setlocal & call :driverupdate & cls & endlocal & goto :geepeeyou
if %_erl%==3 setlocal & call :intelgpu & cls & endlocal & goto :geepeeyou
if %_erl%==2 setlocal & call :nvidiagpu & cls & endlocal & goto :geepeeyou
if %_erl%==1 setlocal & call :amdgpu & cls & endlocal & goto :geepeeyou
...
cd %appdata%
if exist .\driver_rawr\gpu\INTEL_AutoInstall.exe (
 cd %appdata%/driver_rawr/gpu
 del .\INTEL_AutoInstall.exe
 goto :runintel
) else (
  mkdir driver_rawr\gpu 
  goto :runintel
)
...
powershell -c "Invoke-WebRequest -Uri 'https://github.com/NeweggTechie/Downloads/releases/download/GPU-drivers/INTEL_AutoInstall.exe' -OutFile '%appdata%/driver_rawr/gpu/INTEL_AutoInstall.exe'"
title  RUNNING - RAWR
cd %appdata%/driver_rawr/gpu
start .\INTEL_AutoInstall.exe
goto :geepeeyou
...
cd %appdata%
if exist .\driver_rawr\gpu\NV_AutoInstall.exe (
 cd %appdata%/driver_rawr/gpu
 del .\NV_AutoInstall.exe
 goto :runnvidia 
) else (
  mkdir driver_rawr\gpu
  goto :runnvidia
...
:runnvidia
title  DOWNLOADING - RAWR
powershell -c "Invoke-WebRequest -Uri 'https://github.com/NeweggTechie/Downloads/releases/download/GPU-drivers/NV_AutoInstall.exe' -OutFile '%appdata%/driver_rawr/gpu/NV_AutoInstall.exe'"
title  RUNNING - RAWR
cd %appdata%/driver_rawr/gpu
start .\NV_AutoInstall.exe
goto :geepeeyou
...
cd %appdata%
if exist .\driver_rawr\gpu\AMD_AutoInstall.exe (
 cd %appdata%/driver_rawr/gpu
 del .\AMD_AutoInstall.exe
 goto :runamd 
) else (
  mkdir driver_rawr\gpu
  goto :runamd
...
:runamd
title  DOWNLOADING - RAWR
powershell -c "Invoke-WebRequest -Uri 'https://github.com/NeweggTechie/Downloads/releases/download/GPU-drivers/AMD_AutoInstall.exe' -OutFile '%appdata%/driver_rawr/gpu/AMD_AutoInstall.exe'"
title  RUNNING - RAWR
cd %appdata%/driver_rawr/gpu
start .\AMD_AutoInstall.exe
goto :geepeeyou
...
if %_erl%==7 exit
if %_erl%==6 goto:fixes
if %_erl%==5 setlocal & call :networkingall & cls & endlocal & goto :networking
...
if %_erl%==3 exit
if %_erl%==2 setlocal & call :fixes & cls & endlocal & goto :chkdsk
